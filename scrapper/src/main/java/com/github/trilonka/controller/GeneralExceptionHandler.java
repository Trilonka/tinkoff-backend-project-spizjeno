...
import com.github.trilonka.dto.response.ApiErrorResponse;
...
public class GeneralExceptionHandler {
    ...
    public ApiErrorResponse handMessageNotReadableException(HttpMessageNotReadableException exception) {
